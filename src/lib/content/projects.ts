...
export const projects: Project[] = [
	{
		...
		category: 'ai',
		summary: 'Launches stalled waiting for illustrations; I built an AI-to-SVG pipeline with guardrails and human review; delivery dropped from days to hours. Tech: TypeScript, Node.js, Python, OpenAI API, SVG/Canvas, React.',
	...
	},
	{
		...
		category: 'web',
		summary: 'Ops leads lacked live visibility; I built a streaming dashboard with resilient ingestion and latency-aware charts; sub-second updates became the default in weekly reviews. Tech: SvelteKit, TypeScript, WebSockets, D3.js, Tailwind CSS, PostgreSQL.',
	...
	},
	{
		...
		category: 'tools',
		summary: 'Teams used opaque spreadsheets; I built a weighted scoring app with explainability and audit trails; decisions aligned faster with traceable rationale. Tech: Next.js, TypeScript, Prisma, PostgreSQL, Zustand, Playwright.',
